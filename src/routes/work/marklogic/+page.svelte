...
<section class="relative">
  <div class="py-8 px-4 mx-auto max-w-screen-md">
    <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
      <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">MarkLogic Data Hub</h2>
      <p>
        MarkLogic Data Hub is a data integration platform that unifies data from silos and powers modern data applications. It is a key part of the MarkLogic offering.
      </p>
      <h3 class="my-4 text-2xl tracking-tight font-bold text-gray-900 dark:text-white">My involvement</h3>
      <p>
        While at MarkLogic, I created the Data Hub Framework. It started as a quick start for customers looking to unify data into MarkLogic. As I worked with customers, I realized that
        the Data Hub Framework was much more than a quick start. It was a platform that could be used to build data applications. I worked with the product team to make the Data Hub Framework
        a key part of the MarkLogic product line. The project was taken over by MarkLogic Engineering in 2018. It is still in use today and is a key part of the MarkLogic offering.
      </p>
      <h3 class="my-4 text-2xl tracking-tight font-bold text-gray-900 dark:text-white">Working in the open</h3>
      <p class="mb-4">
...
<section class="relative">
  <div class="py-8 px-4 mx-auto max-w-screen-md">
    <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
      <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">Life after Data Hub</h2>
      <p>
        After handing off the Data Hub Framework to the MarkLogic Engineering team, I moved on to other projects. Most notably I worked on the MarkLogic Data Hub Community Edition.
        This started off as a sales engineering tool used to showcase the power of the Data Hub Framework. It was originally codenamed "Top Gun" before a rename to "Envision" until finally settling on Data Hub Central Community Edition.
        It has since grown into an open source tool available to all MarkLogic customers.
      </p>
      <p class="mt-4">
        It's available <a href="https://developer.marklogic.com/code/envision/" class="underline">here.</a>
      </p>

      <p class="mt-4">
        According to the <a href="https://github.com/marklogic-community/data-hub-central-community/graphs/contributors" class="underline">Github repo</a> I'm still the top contributor.
      </p>
      <p class="mt-4">
        As with Data Hub Framework, this started off as a simple tool that evolved into much more.
      </p>
      <h3 class="my-4 text-2xl tracking-tight font-bold text-gray-900 dark:text-white">Tech Stack</h3>
      <p>
        This tool was written in Vue.js with a Spring Boot middle tier. It uses MarkLogic as the backend database.
      </p>
      <div class="flex justify-center mt-4 gap-8">
        <div class="bg-gray-800 text-gray-100 text-xs font-medium inline-flex items-center px-2.5 py-2 rounded dark:bg-gray-700 dark:text-gray-300 w-64">
          <svg class="logo mr-4" viewBox="0 0 128 128" width="24" height="24" data-v-4a9de85b=""><path fill="#42b883" d="M78.8,10L64,35.4L49.2,10H0l64,110l64-110C128,10,78.8,10,78.8,10z" data-v-4a9de85b=""></path><path fill="#35495e" d="M78.8,10L64,35.4L49.2,10H25.6L64,76l38.4-66H78.8z" data-v-4a9de85b=""></path></svg>
          Vue.js
        </div>
        <div class="bg-gray-800 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-2 rounded dark:bg-gray-700 dark:text-gray-300 w-64">
